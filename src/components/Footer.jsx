    ...
    return (
        <div className='mainfooter'>
            <div className='contfooter'>
                ...
                <div className="para">Video downloader is the fastest Youtube Downloader tool that allows you to easily convert and download videos and audios from youtube for free and in the best available quality. Video downloader is the ultimate tool to download unlimited youtube videos without any need for registration. You can quickly convert and download hundreds of videos and music files directly from youtube and other social media websites. We support all audio and video formats like MP3, MP4, M4V, FLV, WEBM, 3GP, WMV, AVI, etc., and the most amazing thing, it's completely free.</div>
            </div>
            <hr className='hrr' />
            <div className='lowerpart'>
                <div className="leftfootcont">
                    <h4>How to Download Youtube videos with Video downloader?</h4>
                    <div>
            ...
            <div className='endfoot'>
                <div>
                    &copy;2022 Video downloader  - Your favorite video converter.
                </div>
